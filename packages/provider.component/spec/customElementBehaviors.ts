...
import { useMockForTasks, initJasmine } from '@tko/utils.spec'
...
describe('Components: Custom elements', function () {
  ...
  beforeEach(function () {
    ...
    var provider = new MultiProvider({ providers: [new DataBindProvider(), new ComponentProvider()] })
  ...
  it('Is possible to pass expressions that can vary observably', function () {
    var rootViewModel = { myobservable: observable('Alpha') },
