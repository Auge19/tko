...
export function registerEventHandler<T extends Element = Element>(
  element: T,
  eventType: string,
  handler: EventListener | JQuery.EventHandler<T>,
  eventOptions: boolean | AddEventListenerOptions = false
): void {
