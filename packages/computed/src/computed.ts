...
export type ComputedReadFunction<T = any, TTarget = any> =
  | Subscribable<T>
  | Observable<T>
  | Computed<T>
  | ((this: TTarget) => T)
...
export function computed<T = any, TTarget = any>(
  evaluatorFunctionOrOptions?: ComputedOptions<T, TTarget> | ComputedReadFunction<T, TTarget>,
  evaluatorFunctionTarget?: any,
